...
main(int argc, char * argv[])
{
   ...
   if (strcmp(argv[2], "metric") == 0)
	   mode = V3D::FULL_BUNDLE_METRIC;
   else if (strcmp(argv[2], "focal") == 0)
      mode = V3D::FULL_BUNDLE_FOCAL_LENGTH;
   else if (strcmp(argv[2], "principal") == 0)
      mode = V3D::FULL_BUNDLE_FOCAL_LENGTH_PP;
   else if (strcmp(argv[2], "radial") == 0)
      mode = V3D::FULL_BUNDLE_RADIAL;
   else if (strcmp(argv[2], "tangential") == 0)
      mode = V3D::FULL_BUNDLE_RADIAL_TANGENTIAL;
   else
   {
